...
export function SneakyButton({
  ...
  return (
    <a
      ...
      target={target}
      rel={rel}
      className={cn('button06 w-inline-block', className)}
    >
      <span className="button06_bg" />
      <span data-text={label} className="button06_inner">
        <span className="button06_text">{label}</span>
      </span>
      <span className="button06_icon" aria-hidden="true">
